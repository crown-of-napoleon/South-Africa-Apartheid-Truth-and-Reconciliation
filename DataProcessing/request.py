...
search_term =  ['apartheid south africa 1950s', 'apartheid south africa 1960s', 
                'apartheid south africa 1970s', 'apartheid south africa 1980s']
num_images = 1000

# Make a request to the API. Iterate through the list of images.
for term in search_term:
    ...
    # Make the request
    response = requests.get(endpoint_url, params={'query': term, 'per_page': num_images}, 
